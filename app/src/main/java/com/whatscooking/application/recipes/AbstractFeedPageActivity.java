...
public abstract class AbstractFeedPageActivity extends BaseActivity {
    ...
    public abstract void fetchRecipes();

    public void handleCallback(Call<RecipesResponse> call) {
                    ...
                    if (response.body() != null) {
                        ...
                        if (responseFromAPI.getRecipes() != null) {
                            ...
                            if (recipeArrayList.size() != 0) {
                                RecipeFeedAdapter recipeFeedAdapter = new RecipeFeedAdapter(AbstractFeedPageActivity.this, recipeArrayList);
